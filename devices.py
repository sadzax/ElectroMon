...
nkvv.work_file_list = Device.work_file_listing(nkvv)
nkvv.work_file = Device.work_file_picking(nkvv, 0)
nkvv.work_file_sep = ';'
...
kiv.work_file_list = Device.work_file_listing(kiv)
kiv.work_file = Device.work_file_picking(kiv, 0)

...
data = pd.read_pickle('main_dataframe_kiv.pkl')
cols = columns.columns_analyzer(device_type='kiv', list_for_columns=columns.columns_list_maker(device_type='kiv', data=data))
input_x=['datetime']
input_y=[ex1]
size_x: int = 14
size_y: int = 6

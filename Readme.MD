...
1. If you are familiar with Git choose a directory on your local machine and clone git repo there via 
```bash
...
Build the image and launch it according to [Runner via Docker](#-run-via-docker) instructions

...
mv1 = 'Графики изменения значений напряжений в фазах А, В и С стороны ВН'
prints.print_flat_graph(input_y=['U_MV'], device_type=dev, data=data, cols=cols, title=mv1)

mv2 = 'Графики изменения активной составляющей токов утечек высоковольтных вводов фаз А, В и С стороны ВН'
prints.print_flat_graph(input_y=['Ia_MV'], device_type=dev, data=data, cols=cols, title=mv2)

mv3 = 'Графики изменения реактивной составляющей токов утечек высоковольтных вводов фаз А, В и С стороны ВН'
prints.print_flat_graph(input_y=['Ir_MV'], device_type=dev, data=data, cols=cols, title=mv3)

mv4 = 'Графики изменения значений tgδ высоковольтных вводов фаз А, В и С стороны ВН'
prints.print_flat_graph(input_y=['tg_MV'], device_type=dev, data=data, cols=cols, title=mv4)

mv5 = 'Графики изменения значений емкостей С1 высоковольтных вводов фаз А, В и С стороны ВН'

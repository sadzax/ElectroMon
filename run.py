...
mv1 = 'Графики изменения значений напряжений в фазах А, В и С стороны ВН-220кВ'
print_flat_graph(input_y=['U_MV'], data=database, title=mv1)

mv2 = 'Графики изменения активной составляющей токов утечек высоковольтных вводов фаз А, В и С стороны ВН-220кВ'
print_flat_graph(input_y=['Ia_MV'], data=database, title=mv2)

mv3 = 'Графики изменения реактивной составляющей токов утечек высоковольтных вводов фаз А, В и С стороны ВН-220кВ'
print_flat_graph(input_y=['Ir_MV'], data=database, title=mv3)

mv4 = 'Графики изменения значений tgδ высоковольтных вводов фаз А, В и С стороны ВН-220кВ'
print_flat_graph(input_y=['tg_MV'], data=database, title=mv4)

mv5 = 'Графики изменения значений емкостей С1 высоковольтных вводов фаз А, В и С стороны ВН-220кВ'
